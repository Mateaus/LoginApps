...
public class AdminAuthenticationActivity extends AppCompatActivity {
    ...
    private static String TAG = "AdminAuthenticateActivity";
        ...
        createBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name.equals("") && !email.equals("") && !phone.equals("") && !role.equals("")){
                    ...
                    Toast.makeText(AdminAuthenticationActivity.this, "Account Authenticated!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(AdminAuthenticationActivity.this, AdminProfileActivity.class);
                    startActivity(intent);

                } else {
                    Toast.makeText(AdminAuthenticationActivity.this, "Fill out all the fields", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
