...
public class AdminConfirmingAccount extends AppCompatActivity {

    private static final String TAG = "AdminConfirmingAccount";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_confirming_account);
                ...
                (mAuth.signInWithEmailAndPassword(emailEt.getText().toString(), passwordEt.getText().toString())).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d(TAG, "UID of new account " + userId);

                            Intent intent = new Intent(AdminConfirmingAccount.this, AdminAuthenticationActivity.class);
