package com.example.mat.systemmanagement.FireBaseAccountActivity.UserInterface.WorkerUI;
...
public class WorkerProfileActivity extends AppCompatActivity {
    ...
    private Button customerBtn, signoutBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserPermission userPermission = new UserPermission(WorkerProfileActivity.this);
        ...
        customerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WorkerProfileActivity.this, RecyclerActivity.class);
