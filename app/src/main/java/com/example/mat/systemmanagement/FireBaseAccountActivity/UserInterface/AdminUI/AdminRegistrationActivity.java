...
public class AdminRegistrationActivity extends AppCompatActivity {
    ...
    private static String TAG = "AdminRegistrationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ProgressDialog progressDialog = ProgressDialog.show(AdminRegistrationActivity.this, "Please wait...", "Processing...", true);
                (mAuth.createUserWithEmailAndPassword(emailregEt.getText().toString(), passwordregEt.getText().toString())).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AdminRegistrationActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void sendVerificationEmail() {
        ...
        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(AdminRegistrationActivity.this, "Email verification sent", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(AdminRegistrationActivity.this, AdminConfirmingAccount.class);
